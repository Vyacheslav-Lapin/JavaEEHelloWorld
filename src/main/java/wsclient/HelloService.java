 ...
 *
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://jaxws.hw/", wsdlLocation = "http://localhost:1212/hello?wsdl")
    ...
    extends Service
{
    ...
    private static final QName HELLOSERVICE_QNAME = new QName("http://jaxws.hw/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://jaxws.hw/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.hw/", "HelloPort"), Hello.class, features);
    }
